...
/**
 * Right Ascension based optimization that assigns targets to telescopes based on their Right Ascension coordinates.
 * Minimizes slew time by spatially grouping targets and distributing them evenly across telescopes.
 * Uses sorted RA blocks for efficient spatial clustering.
 */
public class RightAscensionOptimisation extends NNOptimisation {

    public RightAscensionOptimisation() {
        // No additional initialization needed for RA-based optimization
    }

    /**
     * Creates connections using Right Ascension partitioning strategy.
     * Targets are sorted by RA and distributed in contiguous blocks across telescopes.
     */
    public void createRightAscensionLinks(List<Target> targets, Pointable[] currents, double ratio,
        ...
        // Partition targets using Right Ascension-based assignment
        List<List<Target>> partitions = partitionByRightAscension(availableTargets, currents);
    ...
    /**
     * Partition targets using Right Ascension-based spatial clustering
     */
    private List<List<Target>> partitionByRightAscension(List<Target> targets, Pointable[] currentPositions) {
        ...
        // Create a working copy of targets and sort by Right Ascension
